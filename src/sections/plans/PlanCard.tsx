...
export default function PlanCard({ plan }: Props) {
  return (
    <div
      className={clsx(
        "shadow-card-extra-small relative flex flex-col justify-between items-center rounded-lg",
        "w-full max-w-80 gap-2 p-6",
        plan.isSpecial && "border-primary border-2 pt-8",
      )}
    >
